...
gulp.task("compile", function(cb) {
  return exec(
    "cd static/lib/highlight && node tools/build.js -t browser bash css dockerfile go json scss xml yaml",
...
gulp.task("scripts", function() {
  gulp
    .src("static/lib/highlight/build/highlight.pack.js")
    .pipe(gulp.dest("./static/js"));
  return gulp
    .src("static/lib/highlight/src/styles/*.css")
...
gulp.task(
  ...
  gulp.series(
    ...
    // "compile",
    // "scripts",
    gulp.parallel("styles", "images", "lint"),
    "hugo",
    "htmlminify",
